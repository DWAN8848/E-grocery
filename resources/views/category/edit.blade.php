...
<form action="{{route('category.update',$category->id)}}" method="POST" class="my-5">
    @csrf
    ...
    <div class="flex">
        <input type="submit" class="bg-blue-600 text-white px-4 py-2 mx-2 rounded-lg cursor-pointer" value="Update Category">
